...
export const hero2About: HeroProps = {
  title: `Une entreprise pensée sur mesure pour vos besoins d'immigration`,
  subtitle: `Vision Alpha Voyage a été fondée pour répondre à un besoin croissant d’accompagnement des étudiants africains souhaitant poursuivre leurs études en Russie. Face à des obstacles tels que des informations souvent fragmentées, des démarches administratives complexes et des difficultés financières. de nombreux jeunes aspirant à une éducation internationale se retrouvent dans l’incertitude.`,
...
export const statsAbout: StatsProps = {
  ...
  items: [
    {
      title: 40,
      description: 'Visas obtenus',
    },
    {
      title: 25,
      description: 'D’étudiant suivies',
    },
    {
      title: 6,
    ...
    {
      title: 23,
      description: 'Jobs étudiants trouvés ',
    },
  ],
};
...
export const featuresFourAbout: FeaturesProps = {
  ...
  header: {
    title: 'Notre mission',
    subtitle:
      `Chez Vision Alpha Voyage, notre mission est de faciliter l’accès à l’éducation en Russie pour les étudiants africains en offrans un accompagnement personnalisé à chaque étape, de l’obtention du visa à la recherche d’un emploi étudiant, en passant par la recherche de bourses. Notre objectif est d’aider les étudiants à surmonter les obstacles administratifs et financiers afin qu’ils puissent réaliser leur rêve académique en Russie.`,
  ...
  items: [
    {
      ...
      description: `Nous comprenons que chaque dossier a son ADN c'est pourquoi chaque étudiant bénéficie d'un suivi sur mesure pour simplifier son parcours, de l’obtention du visa à son installation en Russie.`,
      icon: IconUser,
    },
    {
      title: 'Innovation et Flexibité',
      description:
        `Nous cherchons constamment des solutions innovantes pour améliorer la qualité de nos services afin de toujours repondre aux besoins croissants du marché.`,
      icon: IconBulb,
    },
    {
      title: 'Transparence',
      description: `Nous fournissons des informations claires et honnêtes sur les démarches, les coûts et les opportunités, afin de bâtir une relation de confiance.`,
      icon: IconThumbUp,
    },
    {
      title: 'Accessibilité',
      description: `Nous rendons les études en Russie accessibles à tous, en simplifiant les démarches et en offrant des solutions de financement.`,
      icon: IconAdjustments,
    },
    {
      title: 'Engagement',
      description:
        `Nous nous engageons à soutenir chaque étudiant tout au long de son parcours pour assurer leur réussite académique en Russie.`,
      icon: IconHeartHandshake,
    },
    {
      title: 'Éthique',
      description: `Nous agissons avec intégrité et respect, en offrant des conseils honnêtes, transparents et objectifs avec un professionnalisme sans null autre pareil.`,
      icon: IconHomeEco,
    },
  ],
};
...
export const stepsAbout: StepsProps = {
  ...
  header: {
    title: `L'historique de Vision Alpha Voyage`,
    // subtitle:
  ...
  items: [
    {
      title: '2022 : creation de Vision Apha Voyage',
      // description:
    ...
    {
      title: '2023: Occupation des premiers locaux',
      // description:
    ...
    // },
    {
      title: 'Aujourd\'hui : Croissance, developement et expension',
      // description:
